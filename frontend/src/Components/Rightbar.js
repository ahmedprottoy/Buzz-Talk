      ...
      <div className={classes.rightbarWrapper}>
        <div className={classes.birthdayContainer}>
          ...
          <img
            ...
            src="https://cdn-icons-png.flaticon.com/512/1/1531.png"
            alt=""
          />
          ...
          <li className={classes.rightbarFriend}>
            <div className={classes.rightbarProfileImgContainer}>
              <img
                ...
                src="https://st2.depositphotos.com/4760391/10082/i/600/depositphotos_100824156-stock-photo-studio-portrait-of-adolf-hitler.jpg"
                alt=""
              />
