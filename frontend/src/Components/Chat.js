...
export default function Chat() {
  ...
  const handleSubmit = (e) => {
    socket.emit("send-chat-message", {message: newMessage, sender: localStorage.getItem("id"), receiver: userID.toString(), conversationID: conversationID});
      ...
      <div className={classes.chatBox}>
        ...
        <div className={classes.chatUserInfo}>
          ...
          <h1>You are Chatting With...</h1>
            <img src={`http://localhost:3003/auth/images/${img}`} alt="" className={classes.chatUserImg}/>
            <h2>{userName}</h2>
